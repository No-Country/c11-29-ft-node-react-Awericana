...
export function Post ({ title, price, imageUrls, detail, selectedTalle, sellerData }) {
  ...
  if (isBig) {
    return (
    <Desktop {...{ title, price, size: selectedTalle, detail, images: imageUrls, calificacion: sellerData?.calificacion, nombre: sellerData?.nombre, apellido: sellerData?.apellido }}/>
    )
  }
